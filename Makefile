...
# litellm.ai/litellm-operator-bundle:$VERSION and litellm.ai/litellm-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= litellm.ai/litellm-operator
...
.PHONY: test-e2e
test-e2e: ## Run the e2e tests against a Kind k8s instance that is already spun up.
